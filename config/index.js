export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3983d9d3ca4f9c44",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "57825396fa59f496abbbab64767840b2",
  ...
  USERS: [
    {
      ...
      id: "o8uJB528ficwcZ0YJRMdM9EGstZo",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "kHks_6glxaXN5HFJ684UmWFpR8zjavNzDbt7-BFDdRs",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
